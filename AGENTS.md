...
| zero_transpiler | 3 | Syntax rules, AST node reference, known transpiler bugs, and build workflow for Zero, the Lisp-like AI-first language that transpiles to Go. | `.agents/skills/zero_transpiler/SKILL.md` |
<!-- SKILLS_MANIFEST_END -->
