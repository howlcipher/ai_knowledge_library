...
| devops_sre | 2 | Triggers when designing infrastructure-as-code (Terraform, Kubernetes) or building CI/CD pipelines (Azure DevOps, GitLab). | `.agents/skills/devops_sre/SKILL.md` |
...
| Red Team Cyber Operations | 2 | Simulates adversarial techniques and penetration testing methodologies to identify vulnerabilities and improve defensive posture. | `.agents/skills/red_team/SKILL.md` |
