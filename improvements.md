...
* **Gap 1: Vector / RAG Engineering**: We have `database_management`, but lack a specialized skill for chunking algorithms, semantic distance tuning, and embedding model selection.
