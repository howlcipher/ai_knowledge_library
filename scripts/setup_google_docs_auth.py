    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            if not os.path.exists(creds_path):
                ...
                print("  4. In the left sidebar under 'Google Auth Platform', click on 'Audience'.")
                print("  5. Under the 'Test users' section, click '+ ADD USERS' and add your email address.")
                ...
                print(f"  10. Rename it to 'credentials.json' and place it in: {repo_root}")
