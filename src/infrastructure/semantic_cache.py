...
class SemanticCache:
    ...
    def __init__(self, host: str = "localhost", port: int = 6379, db: int = 0):
        ...
        self.ttl_seconds = int(os.environ.get("CACHE_TTL_SECONDS", 86400)) # Default 24 hours
    ...
    def get_cached_response(self, prompt: str, context: str = "") -> Optional[Dict[str, Any]]:
    ...
    def set_cached_response(self, prompt: str, response: Dict[str, Any], context: str = "") -> bool:
