...
| 3 | [Variable Shadowing in Go Generation](#3-variable-shadowing-in-go-generation) | Pending | 4.0 (4×1÷1) | Sonnet 3.5 | Gemini 1.5 Pro | `let` expressions without inner `{}` brackets risk leaking scopes or redeclaring variables, causing Go compilation to fail on nested conditionals. |
