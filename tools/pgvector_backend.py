...
try:
    ...
    print("Dependencies missing. Please install psycopg2-binary, pgvector, and sentence-transformers.")
    sys.exit(1)
...
class PgVectorStore:
    def __init__(self):
        config = get_config()
        dsn = config.get("database", {}).get("pgvector_dsn", "postgresql://localhost:5432/ai_knowledge")
