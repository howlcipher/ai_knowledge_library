...
def main():
    parser = argparse.ArgumentParser(description="AI Translation Agent hook for localizing the repository.")
    parser.add_argument("--lang", type=str, required=True, help="Language code (e.g., ja_JP, zh_CN)")
